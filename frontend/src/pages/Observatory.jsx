...
function PatientPreviewRow({ patient }) {
    ...
    return (
        <tr>
            <td>
                <Link to={`/patients/${patient.id}`} className="flex items-center gap-sm" style={{ textDecoration: 'none', color: 'var(--text-primary)' }}>
                    <div style={{
        ...
        <div className="fade-in">
            ...
            <section className="mb-lg">
                ...
                <div className="flex gap-md">
                    <Link to="/patients" className="btn btn-primary" style={{ textDecoration: 'none' }}>
                        <Users size={16} />
                        View Patients
                    </Link>
                    <Link to="/simulate" className="btn btn-ghost" style={{ textDecoration: 'none' }}>
            ...
            <section>
                <div className="flex items-center justify-between mb-md">
                    ...
                    <Link to="/patients" className="btn btn-ghost btn-sm" style={{ textDecoration: 'none' }}>
                        View All
                ...
                <div className="glass-card no-hover">
                    {patientsLoading ? (
                        ...
                        <div style={{
                            ...
                            <Link to="/patients" className="btn btn-primary btn-sm mt-md" style={{ textDecoration: 'none' }}>
                                <Users size={14} />
                                Add Patient
                            </Link>
                        </div>
