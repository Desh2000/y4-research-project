...
import { listPatients, getPatient, getNextBestAction } from '../api/client';
import {
...
export default function NextBestAction() {
    const { data: patientsResp, loading: patientsLoading } = useApi(listPatients, { key: 'nba-patients' });
            ...
            {!selectedId && !patientsLoading && !loading && (
                <div className="glass-card" style={{ textAlign: 'center', padding: 'var(--sp-8)' }}>
                    ...
                    <p style={{ fontSize: '1.1rem', color: 'var(--text-secondary)', marginBottom: 'var(--sp-2)' }}>
                        Select a patient for an AI recommendation
                    </p>
                    <p className="data-label">
                        The PPO Agent, Seq2Seq Simulator, and LSTM Risk Predictor work together to find the optimal intervention
                    </p>
                </div>
            )}
        </motion.div>
