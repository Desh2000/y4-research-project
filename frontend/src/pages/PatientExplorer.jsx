                        ...
                        {filtered.map(patient => (
                            ...
                            >
                                ...
                                <div style={{
                                    ...
                                    background: patient.cached_risk_level === 'High' ? 'var(--risk)'
                                        : patient.cached_risk_level === 'Medium' ? 'var(--caution)'
                                            : 'var(--success)',
                                    animation: 'pulse-ring 3s ease infinite',
                                    boxShadow: `0 0 8px ${patient.cached_risk_level === 'High' ? 'var(--risk-dim)'
                                            : patient.cached_risk_level === 'Medium' ? 'var(--caution-dim)'
                                                : 'var(--safe-dim)'
                                        }`
                                }} />
                                ...
                                <div className="flex items-center justify-between mt-md">
                                    ...
                                    <div className="flex gap-xs">
                                        ...
                                        <Link to={`/patients/${patient.id}`} className="btn btn-ghost btn-sm" style={{ textDecoration: 'none' }}>
