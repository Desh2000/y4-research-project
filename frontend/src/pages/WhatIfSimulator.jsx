...
import { listPatients, getPatient, simulateWhatIf } from '../api/client';
import {
...
function buildPatientState(patient) {
    ...
    // Generate 7-day synthetic history from patient data
    // In production, this would come from actual wearable data
    ...
    // Static features: 20 normalized demographic values
...
export default function WhatIfSimulator() {
    const { data: patientsResp, loading: patientsLoading } = useApi(listPatients, { key: 'whatif-patients' });
            ...
            {!selectedId && !patientsLoading && (
                <div className="glass-card" style={{ textAlign: 'center', padding: 'var(--sp-8)' }}>
                    ...
                    <p className="data-label">
                        Adjust lifestyle parameters and the Seq2Seq simulator will project the health impact
                    </p>
                </div>
            )}
        </motion.div>
