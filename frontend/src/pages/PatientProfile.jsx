    ...
    if (!patient) {
        return (
            <div className="fade-in">
                ...
                <Link to="/patients" className="btn btn-ghost mt-md" style={{ textDecoration: 'none' }}>
    ...
    return (
        <div className="fade-in">
            ...
            <div className="flex items-center gap-md mb-lg">
                <Link to="/patients" className="btn btn-ghost btn-sm" style={{ textDecoration: 'none', padding: 'var(--space-xs)' }}>
                    <ArrowLeft size={18} />
                </Link>
                <div>
            ...
            <div className="grid-2 mb-lg">
                ...
                >
                    ...
                    <div className="flex flex-col gap-md">
                        <Link to="/simulate" className="btn btn-primary w-full" style={{ textDecoration: 'none', justifyContent: 'center' }}>
                            <FlaskConical size={16} />
                            Run Simulation
                        </Link>
                        <Link to="/compare" className="btn btn-ghost w-full" style={{ textDecoration: 'none', justifyContent: 'center' }}>
                            Compare All Interventions
                        </Link>
                        <Link to="/prescribe" className="btn btn-ghost w-full" style={{ textDecoration: 'none', justifyContent: 'center' }}>
                            Get AI Prescription
                        </Link>
                    </div>
